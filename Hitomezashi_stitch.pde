...
boolean RAINBOW_COLORS = false; // Rainbow gradient, it's fun.
...
// highly recommended that you leave it at numXlines if you want the full
// gradient to display. For chosen colors, any colorSpace is fine.
int colorSpace = numXlines; 
